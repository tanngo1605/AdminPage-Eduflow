...
const StudentReducer = (state = [], action) => {
  switch (action.type) {
    case "FILTER_BY_VALUE":
      ...
      if (namevalue || sectionvalue || classvalue) {
      } else state.filteredStudents = state.students;
      console.log(state, action.payload.class, action.payload.section);
    ...
    case "MODIFY_STUDENT_DATA":
      ...
      state.filteredStudents.map((student) => {
        if (student.key === key)
          return Object.assign(student, action.payload.value);
    ...
    case "ADD_STUDENT_DATA":
      return Object.assign({}, state, {
        filteredStudents: [...state.filteredStudents, action.payload.value],
      });
      ...
      const students = [
        {
          ...
          mothername: "",
          gender: "3211321",
          fatheroccupation: "312312",
          fathermobileno: "321312",
          othermobileno: "41321321",
          admission: "5464",
          image: null,
          key: "1",
        },
