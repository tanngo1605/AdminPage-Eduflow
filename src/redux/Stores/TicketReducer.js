  ...
  switch (action.type) {
    ...
    case 'LOAD_DATA':
      let tickets = [
        ...
        {serialno:'232',date:new Date(2020,6,23),subject:"Not",topic:false,name:'Mr.Johns',problem:"bla bla die",status:"Pending",key:'3'},
        {serialno:'32',date:new Date(2020,5,7),subject:"Tic",topic:false,name:'Mr.Johns',problem:"nothing",status:"Approved",key:'4'},
      ]
