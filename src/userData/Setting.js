...
import { AiOutlineMail,AiOutlineExclamationCircle,AiOutlineBell } from "react-icons/ai";
...
const icons = [
    ...
    {content:'Raise a Ticket',web:'raiseticket',icon: <AiOutlineBell size='1.2vw' color="#66C4E1" />}
];
